...
// Customer-facing display only — relabels internal admin terminology to
// something more presentable, without touching the underlying stored data.
const displayLabel = (text, type) => {
      ...
      <div className="px-4 md:px-8">
        <div className="mb-6">
          ...
          <p className="text-sm text-slate-400 mt-0.5">
            Every transfer, deposit, and adjustment on your account.
          </p>
        </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-navy-900 truncate">
                        {displayLabel(tx.description || tx.category, tx.type)}
                      </p>
                    ...
                    <div className="text-right">
                      <p
                        className={`text-sm font-semibold ${isCredit ? "text-emerald-600" : "text-red-500"}`}
                      >
                        {isCredit ? "+" : "-"}
